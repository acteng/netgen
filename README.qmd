...
```{r}
#| include: false
od_joined_doubly_constrained = left_join(
    res_doubly_constrained,
    od_observed
    )
rsq_doubly_constrained = cor(od_joined_doubly_constrained$frequency, od_joined_doubly_constrained$interaction, use = "complete.obs")^2
rsq_doubly_constrained
```

```{r}
#| label: r-squared-doubly-constrained
res_o = od_joined_doubly_constrained |>
  group_by(O) |>
  summarise(
    Observed = first(origin_pupils_estimated),
    Modelled = sum(interaction),
...
res_d = od_joined_doubly_constrained |>
  group_by(D) |>
  summarise(
    Observed = first(destination_n_pupils),
    Modelled = sum(interaction),
...
res_od = od_joined_doubly_constrained |>
  transmute(
    Observed = frequency,
    Modelled = interaction,
    Type = "OD"
...
```{r}
#| include: false
od_joined_doubly_constrained_2 = left_join(
    res_doubly_constrained_2,
    od_observed
    )
rsq_doubly_constrained_2 = cor(od_joined_doubly_constrained_2$frequency, od_joined_doubly_constrained_2$interaction, use = "complete.obs")^2
...
```{r}
#| include: false
od_joined_doubly_constrained_3 = left_join(
    res_doubly_constrained_3,
    od_observed
    )
rsq_doubly_constrained_3 = cor(od_joined_doubly_constrained_3$frequency, od_joined_doubly_constrained_3$interaction, use = "complete.obs")^2
...
```{r}
#| include: false
od_joined_doubly_constrained_5 = left_join(
    res_doubly_constrained_5,
    od_observed
    )
rsq_doubly_constrained_5 = cor(od_joined_doubly_constrained_5$frequency, od_joined_doubly_constrained_5$interaction, use = "complete.obs")^2
...
```{r}
#| include: false
od_joined_doubly_constrained_7 = left_join(
    res_doubly_constrained_7,
    od_observed
    )
rsq_doubly_constrained_7 = cor(od_joined_doubly_constrained_7$frequency, od_joined_doubly_constrained_7$interaction, use = "complete.obs")^2
