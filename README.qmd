...
od_from_si = od_from_si |>
  mutate(
    ...
    #   distance_euclidean < 1000 ~ 1,
    #   TRUE ~ distance_euclidean / 1000
    # ),
...
names(od_from_si)
gravity_model = function(beta, d, m, n) {
  origin_pupils_estimated * destination_n_pupils * exp(-beta * distance_euclidean / 1000)
}
```
...
conditions = data.frame(
  distance_euclidean = seq(0, 5000, length.out = 100),
