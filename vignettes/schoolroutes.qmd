...
- Inclusion of gradient data (5-10 days)
-  Sense-checking results based on local knowledge with input from inspectors and/or local authority staff (5-10 days)
...
In total, the project would require around 70-200 days of work, depending on the project's ambition and scope.
With the potential to have a substantial impact on active travel to school in England, the project is well worth pursuing.
