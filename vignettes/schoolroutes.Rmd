...
The figure shows the routes with the highest number of trips under the Government Target scenario, which represents a doubling in the number of trips made by cycling to school [@goodman_scenarios_2019].
 <!-- as follows shown in  -->
