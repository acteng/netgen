...
TODO: describe and develop uptake functions for walking and cycling to school.
...
# Same with pmtiles:
file.copy("output_govtarget/rnet.pmtiles", "output_pct_govtarget.pmtiles")
system("gh release upload v0.1.0 output_pct_govtarget.pmtiles")

# GoDutch:
file.copy("output/output.geojson", "output_pct_godutch.geojson")
system("gh release upload v0.1.0 output_pct_godutch.geojson")
file.copy("output/rnet.pmtiles", "output_pct_godutch.pmtiles")
system("gh release upload v0.1.0 output_pct_godutch.pmtiles")
```
...
```{r}
#| eval: false
output_file_godutch = "https://github.com/acteng/netgen/releases/download/v0.1.0/output_pct_govtarget.geojson"
```
...
rnet_govtarget = sf::read_sf(output_file_godutch)
