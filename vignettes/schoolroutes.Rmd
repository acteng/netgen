...
The weighted mean distance travelled is `r round(wm / 1000, 1)` km.
...
The total distance travelled under the Government Target scenario is `r round(total_rnet_govtarget / 1e3) |> format(big.mark = ",")` km.
