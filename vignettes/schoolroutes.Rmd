...
plot(rnet_govtarget, logz = TRUE)
```

The route network object visualised in
 <!-- Figure \@ref(fig:rnet-base) -->
the figure above has the following variables: 
...
<!-- Table \@ref(tab:rnet-govtarget-top5) and Figure \@ref(fig:rnet-govtarget-top5-map). -->
