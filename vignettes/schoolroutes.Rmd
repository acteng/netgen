...
Assuming a trip diversion factor of 1.3 and that 5% of the trips are made by cycling under the Government Target scenario for the short distances travelled to school, we can estimate the total number of trips and distance travelled, as `r round(total_euclidean_cycled / 1000)` km.
...
The equivalent for the route network output is `r round(total_rnet / 1e3)` km.
