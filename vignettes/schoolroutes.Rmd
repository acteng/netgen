...
The approach outlined in this paper use the following datasets:
...
```{r}
readLines("config_pct_godutch_schools.json") |> cat(sep = "\n")
```
...
```{r}
output_file = "output_govtarget/output.geojson"
rnet_govtarget = sf::read_sf(output_file)
